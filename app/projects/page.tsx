  ...
  return (
    <main className="min-h-screen bg-[#020408] pt-24 pb-16">
      ...
      <div className="fixed inset-0 pointer-events-none -z-10" aria-hidden="true">
        <div className="absolute top-0 left-1/4 w-[700px] h-[500px] rounded-full opacity-[0.06] blur-[120px]"
          style={{ background: "radial-gradient(ellipse, #3b82f6, transparent 70%)" }} />
        <div className="absolute bottom-0 right-1/4 w-[600px] h-[400px] rounded-full opacity-[0.06] blur-[100px]"
